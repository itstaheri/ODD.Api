...
using ODD.Api.Infrastructure.Utility.CustomExceptions;
using ODD.Api.Infrastructure.Utility.Helpers.SecurityHelper;
using System;
...
{
    public class DapperSSMSDBHelper : IApplicationDapperContext
    {
        ...
        public DapperSSMSDBHelper(IConfiguration configuration)
        {
        ...
        public async Task<object> CallSPAsync(string spName, DynamicParameters? parameters)
        {
            ...
            connection.ConnectionString = _configuration.GetConnectionString("SSMS");
                ...
                if (queryResult is null)
                {
                  ...
                  //  _logger.LogError($"MethodName : {nameof(CallSPAsync)} Date : {DateTime.Now} Message : Entity is null or Empty");

                    throw new EntityIsNullOrEmptyException(spName);
                }

                //    var json = Newtonsoft.Json.JsonConvert.SerializeObject(query.ToList(), Newtonsoft.Json.Formatting.Indented, new JsonSerializerSettings { }) as string;
                return queryResult;
            }
            catch (Exception ex)
            {
        ...
        public object CallSP(string spName, DynamicParameters? parameters)
        {
            ...
            connection.ConnectionString = _configuration.GetConnectionString("SSMS");
                ...
                //           var json = JsonConvert.SerializeObject(query.ToList(), Newtonsoft.Json.Formatting.Indented, new JsonSerializerSettings { }) as string;
                return queryResult;
            ...
            connection.ConnectionString = _configuration.GetConnectionString("SSMS");
                ...
                if (queryResult is null)
                {
                 ...
                 //   _logger.LogError($"MethodName : {nameof(CallSPAsync)} Date : {DateTime.Now} Message : Entity is null or Empty");
                    ...
                    throw new EntityIsNullOrEmptyException(query);
                }
